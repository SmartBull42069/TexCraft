...
def RegisterData():
    ...
    bpy.types.Scene.CombinationShader=["MIX_SHADER","ADD_SHADER"]
    normalKeys=['BSDF_PRINCIPLED', 'BSDF_PRINCIPLED', 'BSDF_PRINCIPLED', 'BSDF_DIFFUSE', 'BSDF_METALLIC', 'BSDF_GLASS', 'BSDF_GLOSSY', 'BSDF_REFRACTION', 'EEVEE_SPECULAR', 'EEVEE_SPECULAR', 'SUBSURFACE_SCATTERING', 'BSDF_SHEEN', 'BSDF_TOON', 'BSDF_TRANSLUCENT']
    miscKeys=['BSDF_HAIR', 'BSDF_DIFFUSE', 'EMISSION', 'BSDF_GLASS', 'BSDF_GLOSSY', 'BSDF_REFRACTION', 'BSDF_SHEEN', 'BSDF_TRANSLUCENT', 'VOLUME_SCATTER', 'EEVEE_SPECULAR', 'BSDF_PRINCIPLED', 'PRINCIPLED_VOLUME', 'BSDF_RAY_PORTAL', 'SUBSURFACE_SCATTERING', 'BSDF_TOON', 'BSDF_TRANSPARENT', 'VOLUME_ABSORPTION', 'BSDF_METALLIC']
    bpy.types.Scene.shaderNodes=['BSDF_PRINCIPLED', 'VOLUME_SCATTER', 'BSDF_TRANSLUCENT', 'BSDF_TRANSPARENT', 'VOLUME_ABSORPTION', 'BSDF_TOON', 'BSDF_SHEEN', 'BSDF_RAY_PORTAL', 'SUBSURFACE_SCATTERING', 'EEVEE_SPECULAR', 'BSDF_REFRACTION', 'PRINCIPLED_VOLUME', 'BSDF_HAIR_PRINCIPLED', 'BSDF_HAIR', 'BSDF_GLOSSY', 'BSDF_GLASS', 'EMISSION', 'BSDF_METALLIC', 'BSDF_DIFFUSE', 'DISPLACEMENT', 'BUMP']
    ...
    bpy.types.Scene.BakeTypes = {"Base Color": "Base Color", "Metallic": "Metallic", "Roughness": "Roughness","IOR": "IOR","Alpha": "Alpha", "Normal": "Normal","Diffuse Roughness": "Diffuse Roughness",
                                ...
                                "Specular Clear Coat":"Clear Coat","Specular Clear Coat Roughness":"Clear Coat Roughness","Specular Clear Coat Normal":"Clear Coat Normal",
                                ...
                                "Translucent Color":"Color","Translucent Normal":"Normal",
    ...
    bpy.types.Scene.ColorMaps = ["Emission N","Base Color", "Emission Color","Emission", "Diffuse Color", "Diffuse Normal", "Metallic Color", "Emission Color N", "Glass Color", "Glossy Color", "Hair Color N", "Hair Color", "Hair Random Color", "Volume Color", "Volume Absorption Color", "Volume Emission Color", "Refraction Color", "Specular Base Color", "Specular Emissive Color", "Subsurface Scattering Color", "Ray Portal Color", "Sheen Color", "Toon Color", "Volume Absorption Color N", "Transparent Color", "Translucent Color", "Volume Scatter Color"]
    bpy.types.Scene.settingsNames = {"UVIslandMargin": "UV Island Margin", "margin": "Texture margin", "rayDistance": "Ray distance", "extrusion": "Extrusion", "height": "height", "width": "width", "AntialiasingScale": "Anti aliasing Scale",  "UseCustomFolderTree": "Use Custom Folder Tree", "ShadeSmooth": "Shade Smooth", "BakeRegardless": "Bake Regardless", "BakeMulitpleSlots": "Bake Mulitple Slots", "CheckUVOverLap": "Check UV OverLap", "CheckUVOverBound": "Check UV Over Bound", "GenerateUvRegardLess": "Generate Uv RegardLess",
    ...
    bpy.types.Scene.DontMax = ["Ambient Occlusion",
    ...
    bpy.types.Scene.multiResSetup = {
        ...
        "Specular Clear Coat Normal": {"Node": "ShaderNodeNormalMap", "InputOutputName": "Color", "Output": "Normal", "OriginInput": "Normal"}, 
...
def UnregisterData():
    ...
    del bpy.types.Scene.CombinationShader
